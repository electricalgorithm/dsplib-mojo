...
def main() raises:
    ...
    dsplib.plot_wave(
        sawtooth, sawtooth_config.get_number_of_samples(), "sawtooth_basic.png"
    )
    ...
    dsplib.plot_wave(
        triangle, triangle_config.get_number_of_samples(), "triangle_basic.png"
    )
    ...
    dsplib.plot_wave(
        triangle_2x, triangle_amp.get_number_of_samples(), "triangle_2x_amp.png"
    )
