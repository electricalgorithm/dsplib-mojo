...
def main() raises:
  ...
  # Generate sine wave.
  var wave_a = generate_sine_wave_raw(440.0, sample_rate, duration)
  var wave_b = generate_sine_wave_raw(392.0, sample_rate, duration)
  var wave_uniform_noisy = generate_random_uniform_noise_raw(sample_rate, duration)
  var wave_normal_noisy = generate_random_normal_noise_raw(sample_rate, duration)

  # Add waves.
  var wave_a_uni_noise = add_waves(wave_a, wave_uniform_noisy, num_samples)
  var wave_b_uni_noise = add_waves(wave_b, wave_uniform_noisy, num_samples)
  var wave_a_normal_noise = add_waves(wave_a, wave_normal_noisy, num_samples)
  var wave_b_normal_noise = add_waves(wave_b, wave_normal_noisy, num_samples)
  var wave_a_plus_b = add_waves(wave_a, wave_b, num_samples)
  var wave_a_plus_b_plus_uni_noise = add_waves(wave_a_plus_b, wave_uniform_noisy, num_samples)
  var wave_a_plus_b_plus_normal_noise = add_waves(wave_a_plus_b, wave_normal_noisy, num_samples)

  # Save waves.
  plot_wave(wave_a, num_samples, "wave_a.png")
  plot_wave(wave_b, num_samples, "wave_b.png")
  plot_wave(wave_uniform_noisy, num_samples, "wave_uniform_noisy.png")
  plot_wave(wave_normal_noisy, num_samples, "wave_normal_noisy.png")
  plot_wave(wave_a_normal_noise, num_samples, "wave_a_normal_noise.png")
  plot_wave(wave_a_uni_noise, num_samples, "wave_a_uniform_noise.png")
  plot_wave(wave_b_normal_noise, num_samples, "wave_b_normal_noise.png")
  plot_wave(wave_b_uni_noise, num_samples, "wave_b_uniform_noise.png")
  plot_wave(wave_a_plus_b, num_samples, "wave_a_plus_b.png")
  plot_wave(wave_a_plus_b_plus_normal_noise, num_samples, "wave_a_plus_b_plus_normal_noise.png")
  plot_wave(wave_a_plus_b_plus_uni_noise, num_samples, "wave_a_plus_b_plus_uni_noise.png")
